...
export class HomePage implements OnInit {
  ...
  ngOnInit() {
    ...
    // this.http.get<{[key: string]: number | string}[]>(`${environment.apiUrl}/Statistics/GetCumulativeStatisticsForWO`, {
    //   params: {
    ...
    // this.http.get<{[key: string]: number | string}[]>(`${environment.apiUrl}/Statistics/GetCumulativeStatisticsForDepartment`, {
    //   params: {
    //     StartDate: '2023-03-01',
    //     EndDate: '2023-03-13'
    //   }
